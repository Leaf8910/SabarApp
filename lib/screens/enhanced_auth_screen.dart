// screens/enhanced_auth_screen.dart
...
class _EnhancedAuthScreenState extends State<EnhancedAuthScreen> {
  ...
  Future<void> _authenticate() async {
    ...
    if (!_isLogin && _passwordValidation != null && !_passwordValidation!.isValid) {
      setState(() {
  ...
  void _generatePassword() {
    ...
    _onPasswordChanged(generatedPassword);
  }
              ...
              children: <Widget>[
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    helperText: 'We\'ll send you important updates here',
                  ),
                ...
                // Password Strength Indicator (for signup only)
                if (!_isLogin && _passwordValidation != null)
                  Container(
                            ...
                            Expanded(
                              child: LinearProgressIndicator(
                                ...
                                valueColor: AlwaysStoppedAnimation<Color>(
                                  PasswordValidator.getStrengthColor(_passwordValidation!.strength),
                                ),
                              ),
                            ),
                            const SizedBox(width: 8),
                            Text(
                              PasswordValidator.getStrengthText(_passwordValidation!.strength),
                              style: TextStyle(
                                color: PasswordValidator.getStrengthColor(_passwordValidation!.strength),
                                fontWeight: FontWeight.bold,
                                fontSize: 12,
                              ),
                            ),
                ...
                // Password Requirements (for signup only)
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (_passwordValidation != null && _passwordValidation!.errors.isNotEmpty)
                          Column(
                            children: [
                              const SizedBox(height: 8),
